...
import ListaSpesaSelectComponent from "./selects/ListaSpesaSelectComponent";
                ...
                <Row className={ "p-3" }>
                    <Card
                        ...
                        <Col xs={ 12 }>
                            ...
                            <ListaSpesaSelectComponent spesaListaNome={ props.spesaListaNome }
                                                       setSpesaListaNome={ props.setSpesaListaNome }/>
                        </Col>
                                        ...
                                        return (
                                            <ListItem key={ index } disablePadding>
                                                <ListItemButton onClick={ () => {
                                                    removeProdottoFromDatabase ( prodotto.id , user.token )
                                                        .then ( (r) => {
                                                            if ( r === 'success' ) {
